...
#B2=BLUE, B3=GREEN, B4=RED, B5=NEAR-INFRARED, B8=PANCHROMATIC
gdal_merge.py -o $path2$fn2\_rgb3$ext -separate $path$fn\_B2$ext2\
$path$fn\_B3$ext2 $path$fn\_B4$ext2\
