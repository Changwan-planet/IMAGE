...
gdalwarp -t_srs '+proj=utm +zone=48 +datum=WGS84' $path2$fn\_B$ext2 $path2$fn2\_B_warp$ext2 
gdalwarp -t_srs '+proj=utm +zone=48 +datum=WGS84' $path2$fn\_G$ext2 $path2$fn2\_G_warp$ext2 
gdalwarp -t_srs '+proj=utm +zone=48 +datum=WGS84' $path2$fn\_R$ext2 $path2$fn2\_R_warp$ext2 


echo RGB COMPOSITION
#BGRN -> sequence along the wavelength
gdal_merge.py -o $path2$fn2\_rgb3$ext -separate $path$fn2\_B_warp$ext2\
$path$fn2\_G_warp$ext2 $path$fn2\_R_warp$ext2\
